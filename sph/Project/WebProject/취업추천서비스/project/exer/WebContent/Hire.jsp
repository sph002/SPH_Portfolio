...
<head>
 ...
 <br>
   ...
   <table width="1600px" border="0" cellspacing="0" cellpadding=" align="center" >
      <tr>
        <td width="800px" bgcolor="#1C86EE" 
        style=
      					"border-bottom: 1px solid #CECECE;
								border-left: 1px solid #CECECE;
								border-right: 1px solid #CECECE;
								bgcolor:#1C86EE; align:center; height:60;
								font-weight:bold; font-size:23px" >
				<font color=#FFFFFF >공채달력</font>
				</td>
        <td width="800px" bgcolor="#1C86EE" 
        style=
      					"border-bottom: 1px solid #CECECE;
								...
								bgcolor:#1C86EE; align:center; height:60;
								font-weight:bold; font-size:23px">
				<font color=#FFFFFF >채용검색</font>
				</td>
      </tr>
      <tr>
        <td class="center" style="border-bottom: 1px solid #CECECE;
																				  border-left: 1px solid #CECECE;
																				  border-right: 1px solid #CECECE">	
							<iframe id="pageFrame" name="pageFrame" src="http://www.jobkorea.co.kr/Starter/calendar/sub/month" frameborder="0"
												width="800px" height="1250px" scrolling="auto" align="middle"></iframe>
					</td>
        ...
        <td align="center" style="border-bottom: 1px solid #CECECE;
																				  ...
																				  border-right: 1px solid #CECECE;">
																				  <br>
							<iframe id="Search" scrolling="auto" frameborder="0" name="Search" src="http://192.168.152.3/web.php" width="800px" height="1250px"></iframe>
					</td>
